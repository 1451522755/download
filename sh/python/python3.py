...
def main():
    ...
    exe_cmd("mv /usr/bin/python /usr/bin/python.bak")
    exe_cmd("ln -s /usr/local/bin/python3 /usr/bin/python")
    exe_cmd("mv /usr/bin/pip /usr/bin/pip.bak")
    exe_cmd("ln -s /usr/local/bin/pip3.7 /usr/bin/pip")
    print ("程序执行完成！输入 python -V 查看效果。")
